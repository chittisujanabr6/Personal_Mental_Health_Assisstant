...
**Objectives**
- Provide a calm and empathetic conversational experience  
- Encourage users to reflect on emotions and thoughts  
- Promote mental health awareness using technology  

**Tech Stack**
- Language: Python
- Logic: Rule-based responses / ML model
- Environment: Command Prompt

**Features**
- Conversational mental health support  
- Stress and emotion check-ins 
